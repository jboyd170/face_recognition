...
def load_known_faces():
    ...
    try:
        with open("known_faces.dat", "rb") as face_data_file:
            ...
            print(face_encodings, known_face_metadata)
...
def main_loop():
    ...
    #known_dir = 'known_colab' moved to top of program
    #unknown_dir = 'unknown'moved to top of program
    ...
    #colab coding
    #known_encodings = [] moved to top of program
    #known_names = [] moved to top of program
